document.addEventListener('DOMContentLoaded', function () {
  ...
  function initScrollAnimations() {
    if (!('IntersectionObserver' in window)) {
      OBSERVED_SELECTORS.forEach(function (selector) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מחסני הריהוט - מהיצרן לצרכן משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '14c0da5a-a4bc-46c3-b580-243c34be744e',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '14c0da5a-a4bc-46c3-b580-243c34be744e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '14c0da5a-a4bc-46c3-b580-243c34be744e';
